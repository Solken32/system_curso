    ...
    <footer class="pt-10 bg-gray-800">
        <div class="max-w-screen-xl mx-auto px-4 md:px-8">
            ...
            <div class="mt-5 py-10 border-t border-gray-700 items-center justify-between sm:flex" >
                <p class="text-gray-300">
                © 2024 InnovaSoft Inc- Jech. Todos los derechos reservados.
                </p>
                <div class="flex items-center gap-x-6 text-gray-400 mt-2">
